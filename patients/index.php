        ...
        <div class="row justify-content-center w-100">
          <div class="col-md-8 col-lg-7 col-xl-6">
            ...
            <p>To participate in this study you must give informed consent.</p>
              ...
              <div class="custom-control custom-checkbox my-4 d-flex justify-content-start">
                <div class="round mx-4">
                  <input type="checkbox" id="checkbox" class="give_consent"/>
                  <label for="checkbox"></label>
                </div>
                <label class="" style="position:relative;left:-60px;">
                  I consent to take part in the research study
                </label>
              </div> 

              <div class="form-group mt-2">
                <a  href="./signUp/upload-consent.php" class="btn-block btn btn-primary btn-lg start_button isDisabled"> Start </a>
              </div>
