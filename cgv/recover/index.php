...
<html lang="en">
  ...
  <head>
    <meta charset="utf-8">
    <title>Prose | forgot password</title>
        ...
        <div class="row justify-content-center w-100">
          <div class="col-md-8 col-lg-7 col-xl-6">
            ...
            <form class ="forgotPasswordForm" method="post" action="./check-mail.php">
                ...
                <p class="input_text_label2 my-4 text-center">Need help? <a href="mailto:support@gmail.com"> Contact support </a> for <br/> forgotten password issues.</p>
             </form>
